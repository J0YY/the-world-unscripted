              ...
              <div className="pointer-events-none absolute left-0 top-full z-50 mt-2 hidden w-[360px] max-w-[85vw] rounded-lg border border-[var(--ds-gray-alpha-200)] bg-[var(--ds-background-100)] p-3 text-xs text-[var(--ds-gray-900)] shadow-xl group-hover:block">
                ...
                <div className="mt-3 grid grid-cols-2 gap-2">
                  <div className="rounded bg-[var(--ds-gray-alpha-100)] p-2">
                    <div className="text-[10px] font-mono uppercase tracking-wider text-[var(--ds-gray-600)]">Resources</div>
                  ...
                  <div className="rounded bg-[var(--ds-gray-alpha-100)] p-2">
                    <div className="text-[10px] font-mono uppercase tracking-wider text-[var(--ds-gray-600)]">Starting assessment</div>
                    <div className="mt-1 text-[11px] text-[var(--ds-gray-900)]">
                      Econ: {snapshot.countryProfile.startingAssessment.economicStability.level}
                      <br />
                      Legitimacy: {snapshot.countryProfile.startingAssessment.legitimacy.level}
                      <br />
                      Unrest: {snapshot.countryProfile.startingAssessment.unrest.level}
                      <br />
                      Intel: {snapshot.countryProfile.startingAssessment.intelClarity.level}
                    </div>
                  </div>
                </div>
